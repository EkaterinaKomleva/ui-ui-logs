...
async function fetchCalculations() {
  ...
  try {
    ...
    Object.keys(instancesByModules).forEach(instance => {
      addChart(
        `container${++indexOfChart}`,
    ...
    Object.keys(instancesBySystemConfModules).forEach(instance => {
      addChart(
        `container${++indexOfChart}`,
...
function addAllInstancesChart(countsOfInstances, countOfDays) {
  Highcharts.chart(`container${++indexOfChart}`, {
    chart: {
      type: 'column',
    },
    title: {
